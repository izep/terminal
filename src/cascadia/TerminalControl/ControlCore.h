...
#pragma region TerminalCoreCallbacks
        ...
        void _terminalCommandFinishedWithError(std::wstring_view command, std::wstring_view output, unsigned int exitCode, const til::CoordType& bufferRow);
        void _terminalPredictNextCommand();
